...
function getCurrentWeather() {
    ...
    var api = 'https://api.openweathermap.org/data/2.5/weather?q=' + searchInput + '&units=imperial&appid=76db80d7cffbdb0aad58fd5a05192940';
    console.log(api);
    fetch(api)
...
function getFiveDay() {
    var searchInput = document.querySelector(".search-input").value;
    var api = 'https://api.openweathermap.org/data/2.5/forecast?q=' + searchInput + '&units=imperial&appid=76db80d7cffbdb0aad58fd5a05192940';
    console.log(api);
    fetch(api)
    .then(function(response) {
        return response.json();
